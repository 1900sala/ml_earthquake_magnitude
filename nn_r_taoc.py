...
f_threshold = np.where((label > 3.3)&(label < 6))
n_threshold1 = np.where((label <6)&(label > 5))
n_threshold2 = np.where((label <4.3)&(label > 3.3))
data =  np.concatenate((data[f_threshold[0]], data[n_threshold1[0]], data[n_threshold2[0]]
                        , data[n_threshold1[0]], data[n_threshold2[0]]), axis=0)
label =  np.concatenate((label[f_threshold[0]], label[n_threshold1[0]], label[n_threshold2[0]]
                         , label[n_threshold1[0]], label[n_threshold2[0]]), axis=0)
dis = np.concatenate((dis[f_threshold[0]], dis[n_threshold1[0]], dis[n_threshold2[0]]
...
regularizers = 0.02*(tf.nn.l2_loss(W_fc1) + tf.nn.l2_loss(W_fc2) + tf.nn.l2_loss(W_fc3) + tf.nn.l2_loss(W_fc4) +
                tf.nn.l2_loss(W_fc5) + tf.nn.l2_loss(W_fc6) + tf.nn.l2_loss(W_fc7) + tf.nn.l2_loss(W_fc8) ) + \
               tf.contrib.layers.l1_regularizer(0.0001)(W_fc1)+tf.contrib.layers.l1_regularizer(0.0001)(W_fc2)+ \
               tf.contrib.layers.l1_regularizer(0.0001)(W_fc3)+ tf.contrib.layers.l1_regularizer(0.0001)(W_fc4)+\
               tf.contrib.layers.l1_regularizer(0.0001)(W_fc5)+ tf.contrib.layers.l1_regularizer(0.0001)(W_fc6)+\
               tf.contrib.layers.l1_regularizer(0.0001)(W_fc7)+ tf.contrib.layers.l1_regularizer(0.0001)(W_fc8)
